  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 min-h-0 p-2 pb-0 gap-px">
            ...
            <div className="flex flex-col gap-px flex-1">
              ...
              <div className="overflow-hidden">
                <div className="flex flex-col gap-px">
                  {[
                    { icon: Globe, label: "打开Google" },
                    { icon: MessageSquare, label: "搜索相关信息" },
                    { icon: FileText, label: "总结项目文档" },
                    { icon: Library, label: "浏览资源库" },
                  ].map((task) => (
                    <button
                      key={task.label}
        ...
        {/* Collapsed state - task list indicators */}
        {isCollapsed && (
      ...
      {/* Footer */}
      <div className="flex flex-col justify-center items-start gap-2 bg-background p-2 overflow-hidden border-t border-border">
        {!isCollapsed ? (
          ...
          <div className="flex items-center p-0.5 flex-wrap gap-1 w-[52px]">
            <a
              href="https://manus.im/docs/zh-cn"
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center cursor-pointer rounded-md hover:bg-muted size-8"
            >
