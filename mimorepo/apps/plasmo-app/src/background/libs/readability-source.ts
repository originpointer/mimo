/**
 * Embedded Mozilla Readability library source
 * Auto-generated from .sources/readability/
 * Copyright (c) 2010 Arc90 Inc - Apache License 2.0
 *
 * Source files:
 * - Readability.js (90903 bytes)
 * - Readability-readerable.js (4279 bytes)
 */

// Readability.js - Full source embedded
...
// Readability-readerable.js - Full source embedded
export const READABILITY_READABLE_SOURCE = `/*
 * Copyright (c) 2010 Arc90 Inc
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
