# orama-js: Introduction to search
URL: /docs/orama-js/search
Source: https://raw.githubusercontent.com/oramasearch/docs/refs/heads/main/content/docs/orama-js/search/index.mdx

Learn how to search through your documents with Orama.
