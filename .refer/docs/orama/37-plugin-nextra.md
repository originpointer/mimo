# orama-js: Plugin Nextra
URL: /docs/orama-js/plugins/plugin-nextra
Source: https://raw.githubusercontent.com/oramasearch/docs/refs/heads/main/content/docs/orama-js/plugins/plugin-nextra.mdx

Learn how to use the Nextra plugin in Orama.
