# orama-js: Plugin Astro
URL: /docs/orama-js/plugins/plugin-astro
Source: https://raw.githubusercontent.com/oramasearch/docs/refs/heads/main/content/docs/orama-js/plugins/plugin-astro.mdx

Learn how to use the Astro plugin in Orama.
