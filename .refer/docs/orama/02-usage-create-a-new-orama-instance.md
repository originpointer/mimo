# orama-js: Create a new Orama instance
URL: /docs/orama-js/usage/create
Source: https://raw.githubusercontent.com/oramasearch/docs/refs/heads/main/content/docs/orama-js/usage/create.mdx

Create a new Orama instance to store and search documents.
