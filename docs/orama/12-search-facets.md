# orama-js: Facets
URL: /docs/orama-js/search/facets
Source: https://raw.githubusercontent.com/oramasearch/docs/refs/heads/main/content/docs/orama-js/search/facets.mdx

Learn how to use facets in Orama search engine.
