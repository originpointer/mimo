# orama-js: Components
URL: /docs/orama-js/internals/components
Source: https://raw.githubusercontent.com/oramasearch/docs/refs/heads/main/content/docs/orama-js/internals/components.mdx

Learn how to customize Orama by using its components architecture.
