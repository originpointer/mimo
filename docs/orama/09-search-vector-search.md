# orama-js: Vector Search
URL: /docs/orama-js/search/vector-search
Source: https://raw.githubusercontent.com/oramasearch/docs/refs/heads/main/content/docs/orama-js/search/vector-search.mdx

Learn how to perform vector search using Orama.
