# orama-js: Stop-words
URL: /docs/orama-js/text-analysis/stop-words
Source: https://raw.githubusercontent.com/oramasearch/docs/refs/heads/main/content/docs/orama-js/text-analysis/stop-words.mdx

Learn how to use stop-words with Orama.
